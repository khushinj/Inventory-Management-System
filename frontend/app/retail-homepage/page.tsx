...
const operations: OperationCard[] = [
  ...
  {
    title: "Sales",
    description: "Process retail sales transactions",
    icon: ShoppingCart,
  ...
  {
    title: "Return",
    description: "Handle product returns from customers",
    icon: Undo2,
    bgColor: "bg-red-500",
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-10">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Retail Shop</h1>
          ...
          {operations.map((operation) => {
            ...
            return operation.href ? (
              <Link
                key={operation.title}
                href={operation.href}
                className="block group focus:outline-none focus-visible:ring-4 focus-visible:ring-blue-200 focus-visible:ring-offset-2 rounded-xl"
              >
                {CardContent}
              </Link>
            ) : (
